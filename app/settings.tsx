    ...
    if (selectedSource) {
      const fetchDataBasedOnSource = async () => {
        if (selectedSource === "GPS") {
          ...
          fetchData(
            "https://almahdicentre.org/wp-json/prayer-times/v1/data",
            async (data) => {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        >
          ...
          {selectedSource === "GPS" && <Text style={styles.checkMark}>✔</Text>}
        </TouchableOpacity>
      ...
      <View style={styles.valuesContainer}>
        <Text style={styles.valueText}>Selected source: {selectedSource}</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        {Object.keys(prayerTimes)
          .filter(
            (key) => key !== "Date" && key !== "Islamic Date" && key !== "date" && key !== "Sunrise"
          )
          .map((key) => (
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Switch
            ...
            thumbColor={newsPush ? "#c99d2d" : "#f4f3f4"}
            trackColor={{ false: "gray", true: "#00203FFF" }}
          />
        </View>
      </View>
